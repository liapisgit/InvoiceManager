    ...
    el: {
      translation: {
        ...
        admin: {
          navLabel: "Ρυθμίσεις",
          title: "Ρυθμίσεις",
          subtitle: "Διαχείριση εταιρειών, κέντρων κόστους και υπευθύνων έγκρισης.",
          fetchError: "Δεν ήταν δυνατή η φόρτωση των ρυθμίσεων.",
          saveError: "Δεν ήταν δυνατή η αποθήκευση των αλλαγών.",
          companies: "Εταιρείες",
          companyToEdit: "Εταιρεία προς επεξεργασία",
          companyEditHint: "Αφήστε το κενό για να προσθέσετε νέα εταιρεία.",
          addNewCompany: "Προσθήκη νέας εταιρείας",
          inactive: "ανενεργό",
          displayName: "Εμφανιζόμενο όνομα",
          legalName: "Επωνυμία",
          vatNumber: "ΑΦΜ",
          selfProject: "Ίδιο έργο",
          active: "Ενεργό",
          updateCompany: "Ενημέρωση εταιρείας",
          addCompany: "Προσθήκη εταιρείας",
          projects: "Έργα",
          projectToEdit: "Έργο προς επεξεργασία",
          projectEditHint: "Αφήστε το κενό για να προσθέσετε νέο έργο.",
          addNewProject: "Προσθήκη νέου έργου",
          personalProjectsDerived: "Τα έργα PERSONAL προέρχονται από τους χρήστες.",
          updateProject: "Ενημέρωση έργου",
          addProject: "Προσθήκη έργου",
          selfProjectManagedByCompany:
    ...
    en: {
      translation: {
        ...
        admin: {
          navLabel: "Settings",
          title: "Settings",
          subtitle: "Manage companies, cost centers, and approvers.",
          fetchError: "Could not load settings.",
          saveError: "Could not save changes.",
          companies: "Companies",
          companyToEdit: "Company to edit",
          companyEditHint: "Leave empty to add a new company.",
          ...
          projects: "Projects",
          projectToEdit: "Project to edit",
          projectEditHint: "Leave empty to add a new project.",
          addNewProject: "Add new project",
          personalProjectsDerived: "PERSONAL projects come from users.",
