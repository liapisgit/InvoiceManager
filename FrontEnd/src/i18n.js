    ...
    el: {
      translation: {
        ...
        duplicates: {
          ...
          subtitle:
            "Τα διπλότυπα εντοπίζονται από τιμολόγια που έχουν το ίδιο MARK, ανεξάρτητα από την κατάστασή τους.",
          ...
          markTitle: "MARK {{mark}}",
          groupHelp:
            "Επίλεξε ποια καταχώρηση θα κρατηθεί και διέγραψε τις υπόλοιπες.",
          records_one: "{{count}} εγγραφή",
          records_other: "{{count}} εγγραφές",
          keepRecord: "Κράτησε αυτή",
          keepingRecord: "Κρατείται",
          deleteRecord: "Διαγραφή",
          createdBy: "Χρήστης: {{user}}",
          emptyTitle: "Δεν βρέθηκαν διπλότυπα",
          emptyDescription:
            "Δεν υπάρχουν δύο ή περισσότερα τιμολόγια με το ίδιο MARK.",
          fetchError: "Δεν ήταν δυνατή η φόρτωση των διπλότυπων.",
          deleteTitle: "Διαγραφή τιμολογίου",
          deletePrompt:
            "Θες σίγουρα να διαγράψεις το {{invoice}} από την ομάδα MARK {{mark}};",
    ...
    en: {
      translation: {
        ...
        duplicates: {
          ...
          subtitle:
            "Duplicates are detected from invoices that share the same MARK, regardless of their status.",
          groupCount_one: "{{count}} group",
          groupCount_other: "{{count}} groups",
          invoiceCount_one: "{{count}} invoice",
          invoiceCount_other: "{{count}} invoices",
          markTitle: "MARK {{mark}}",
          groupHelp: "Choose the record to keep, then delete the other records.",
          records_one: "{{count}} record",
          records_other: "{{count}} records",
          keepRecord: "Keep this",
          keepingRecord: "Keeping",
          deleteRecord: "Delete",
          createdBy: "User: {{user}}",
          emptyTitle: "No duplicates found",
          emptyDescription: "There are no two or more invoices with the same MARK.",
          fetchError: "Could not load duplicate invoices.",
          deleteTitle: "Delete invoice",
          deletePrompt:
            "Delete {{invoice}} from duplicate group MARK {{mark}}?",
